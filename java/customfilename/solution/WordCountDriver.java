...
import org.apache.hadoop.mapreduce.lib.output.FakeTextOutputFormat;
...
public class WordCountDriver extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
	...
	job.setNumReduceTasks(1);	// Force to 1
	LazyOutputFormat.setOutputFormatClass(job, FakeTextOutputFormat.class);
